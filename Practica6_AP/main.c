...
int main(int argc, char** argv) {
    ...
    //Lineas necesarias para emplear el explorador de archivos
    OPENFILENAME ofn;
    char szFile[100];
    ...
    ofn.lpstrFilter = "Image files (*.jpg;*.png;*.bmp)\0*.jpg;*.png;*.bmp\0" "All\0*.*\0";
    ofn.nFilterIndex = 1;
    ...
    IplImage* aves = cvLoadImage(ofn.lpstrFile, CV_LOAD_IMAGE_UNCHANGED);
